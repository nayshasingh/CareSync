        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(
                        config -> config
                                ...
                                .requestMatchers(HttpMethod.PUT, "/appointments/cancel/**").hasAuthority("PATIENT")
                                .requestMatchers(HttpMethod.PUT, "/appointments/reschedule").hasAuthority("PATIENT")
                                .requestMatchers(HttpMethod.PUT, "/appointments/complete/**").hasAuthority("DOCTOR")
                                .requestMatchers("/appointments").authenticated()
                                .requestMatchers("/appointments/**").authenticated()
                                .requestMatchers(HttpMethod.POST, "/availabilities/generate").hasAuthority("DOCTOR")
                                ...
                                .requestMatchers("/audit-logs/**").authenticated()
                                .requestMatchers("/notification-logs").authenticated()
                                .requestMatchers("/notification-logs/**").authenticated()
